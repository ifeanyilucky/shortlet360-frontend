...
I've successfully implemented a comprehensive sitemap generation system for your aplet360 frontend application. The system automatically generates XML sitemaps for SEO optimization and includes both static and dynamic routes.
...
```javascript
baseUrl: "https://aplet360.com"; // Change to your domain
```
...
1. **Update Base URL**: Change `https://aplet360.com` to your actual domain
