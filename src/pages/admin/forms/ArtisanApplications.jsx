...
export default function ArtisanApplications() {
  ...
  const fetchSubmissions = async () => {
    try {
      ...
      const params = {
        ...
        form_type: "artisan_application", // Filter for artisan applications only
        ...filters,
      };
      ...
      toast.error("Failed to fetch artisan applications");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUpdateSubmission = async (e) => {
    ...
    try {
      ...
      toast.success("Artisan application updated successfully");
            ...
            <div>
              ...
              <div className="text-xs sm:text-sm text-gray-900 bg-gray-50 p-3 rounded">
                ...
                <p>
                  ...
                  {selectedSubmission.location?.local_government}
                </p>
                <p>{selectedSubmission.location?.state}</p>
              </div>
            </div>
