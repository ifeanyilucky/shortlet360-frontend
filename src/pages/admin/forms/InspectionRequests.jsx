  ...
  const fetchSubmissions = async () => {
    try {
      ...
      const params = {
        ...
        form_type: "inspection_request", // Filter for inspection requests only
        ...filters,
      };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage property inspection requests</p>
        </div>
        <button
              ...
              {submissions.map((submission) => (
                <tr key={submission._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      <div className="text-sm font-medium text-gray-900">
                        {submission.property_address?.street}
                      </div>
                      <div className="text-sm text-gray-500">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {selectedSubmission.inspection_type}
                </p>
              </div>
            </div>
      ...
      <Modal
        ...
        title="Update Inspection Request"
      >
        {selectedSubmission && (
          <form onSubmit={handleUpdateSubmission} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Add notes about this inspection request..."
              />
            </div>
