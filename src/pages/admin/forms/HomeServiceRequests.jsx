...
export default function HomeServiceRequests() {
  ...
  const fetchSubmissions = async () => {
    try {
      ...
      const params = {
        ...
        form_type: "home_service", // Filter for home service only
        ...filters,
      };
      ...
      toast.error("Failed to fetch home service requests");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUpdateSubmission = async (e) => {
    ...
    try {
      ...
      toast.success("Home service request updated successfully");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Manage home service requests from users
          </p>
        </div>
        <button
                ...
                <tr key={submission._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      {submission.custom_service && (
                        <div className="text-sm text-gray-500">
                          Custom: {submission.custom_service}
                        </div>
                      )}
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      <div className="flex items-center">
                        ...
                        {submission.address?.area}, {submission.address?.state}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
      ...
      <Modal
        ...
        title="Home Service Request Details"
      >
        {selectedSubmission && (
          <div className="space-y-6">
            ...
            <div>
              ...
              {selectedSubmission.custom_service && (
                <p className="text-sm text-gray-600 mt-1">
                  Custom Service: {selectedSubmission.custom_service}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="text-sm text-gray-900 bg-gray-50 p-3 rounded">
                <p>{selectedSubmission.address?.street}</p>
                <p>
                  {selectedSubmission.address?.area},{" "}
                  {selectedSubmission.address?.local_government}
                </p>
                <p>{selectedSubmission.address?.state}</p>
              </div>
            </div>
      ...
      <Modal
        ...
        title="Update Home Service Request"
      >
        {selectedSubmission && (
