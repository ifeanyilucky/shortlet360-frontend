...
export default function PropertyManagement() {
  ...
  const fetchSubmissions = async () => {
    try {
      ...
      const params = {
        ...
        form_type: "property_management", // Filter for property management only
        ...filters,
      };
      ...
      console.error("Error fetching property management applications:", error);
      toast.error("Failed to fetch property management applications");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUpdateSubmission = async (e) => {
    ...
    try {
      ...
      toast.success("Property management application updated successfully");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Manage property management applications
          </p>
        </div>
        <button
                ...
                <tr key={submission._id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">
                        Request #{submission._id?.slice(-6)}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      {submission.management_duration && (
                        <div className="text-sm text-gray-500">
                          Duration: {submission.management_duration}
                        </div>
                      )}
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">
                        {submission.property_address?.area},{" "}
                        {submission.property_address?.state}
                      </div>
                      {submission.number_of_units && (
                        <div className="text-sm text-gray-500">
                          Units: {submission.number_of_units}
                        </div>
                      )}
                    </div>
                  </td>
      ...
      <Modal
        ...
        title="Property Management Request Details"
      >
        {selectedSubmission && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {selectedSubmission.number_of_units && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Number of Units
                  </label>
              ...
              {selectedSubmission.management_duration && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Management Duration
                  </label>
            ...
            <div>
              ...
              <div className="text-sm text-gray-900 bg-gray-50 p-3 rounded">
                <p>{selectedSubmission.property_address?.street}</p>
                <p>
                  {selectedSubmission.property_address?.area},{" "}
                  {selectedSubmission.property_address?.local_government}
                </p>
                <p>{selectedSubmission.property_address?.state}</p>
              </div>
            </div>

            {selectedSubmission.current_rental_income && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Current Rental Income
                </label>
                <p className="text-sm text-gray-900">
                  ₦{selectedSubmission.current_rental_income?.toLocaleString()}
                </p>
              </div>
            )}
      ...
      <Modal
        ...
        title="Update Property Management Request"
      >
        {selectedSubmission && (
          <form onSubmit={handleUpdateSubmission} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Add notes about this property management request..."
              />
            </div>
