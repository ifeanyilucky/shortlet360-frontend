...
export default function OwnerDisputeResolution() {
  const [formData, setFormData] = useState({
    ...
    bookingReference: "",
    propertyName: "",
    otherPartyId: "", // ID of tenant/guest
    description: "",
    urgencyLevel: "medium",
  });
  ...
  const disputeTypes = [
    "Property Damage by Tenant/Shortlet Guest",
    "Payment Issues from Tenant/Shortlet Guest",
    "Tenant/Shortlet Guest Violation of House Rules",
    "Unauthorized Tenant/Shortlet Guest/Parties",
    "Late Checkout/Overstay by Tenant/Shortlet Guest",
    "Cleaning/Maintenance Disputes by Tenant/Shortlet Guest",
    "Tenant/Shortlet Guest Communication Problems",
    "Cancellation Disputes by Tenant/Shortlet Guest",
    ...
    <div className="p-4 md:p-6 ">
      ...
      <div className="bg-white rounded-xl shadow p-6">
        ...
        <p className="text-gray-600 mb-8">
          Please provide detailed information about your dispute. Include any
          evidence such as photos, messages, or documentation to help us resolve
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Enter the ID of the tenant/shortlet guest involved in this
                dispute
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
              placeholder="Please provide a detailed description of the issue, including dates, times, guest behavior, property damage, or any relevant circumstances..."
            ></textarea>
            <p className="text-xs text-gray-500 mt-1">
              Include as much detail as possible, including any evidence you
              have (photos, messages, etc.)
            </p>
          </div>
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        <p className="text-sm text-gray-600 mb-2">
          For urgent matters or property emergencies, contact our support team
          directly:
        </p>
